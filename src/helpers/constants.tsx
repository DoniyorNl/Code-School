import { Book, Camera, Cpu, GraduationCap, Mouse, Music, Network, ShoppingCart } from 'lucide-react'
...
export const firstLevelMenu: IFirstLevelMenu[] = [
	{ route: 'courses', name: 'Courses', icon: <GraduationCap />, id: PageCategory.Courses },
	{ route: 'books', name: 'Books', icon: <Book />, id: PageCategory.Books },
]
